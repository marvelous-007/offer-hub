use crate::events::{emit_contract_initialized, emit_reward_claimed};
use crate::storage::{
    add_user_reward, get_admin, get_user_rewards, is_event_claimed, mark_event_claimed, set_admin,
};
use crate::types::{require_auth, Error, RewardData};
