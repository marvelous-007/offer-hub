...
export class StorageService implements OnModuleInit {
  ...
  async getFileUrl(
    ...
    try {
      ...
      this.logger.error(
        `Error generating URL for object ${objectName}: ${error.message}`,
      );
      throw error;
    }
  }
  ...
  async downloadFile(
    ...
    try {
      ...
      this.logger.error(
        `Error downloading object ${objectName}: ${error.message}`,
      );
      throw error;
    }
  }
  ...
  async deleteFile(objectName: string): Promise<void> {
    try {
      ...
      this.logger.error(
        `Error deleting object ${objectName}: ${error.message}`,
      );
      throw error;
    }
  }
