  ...
  return (
    <div className={cn('space-y-4', className)}>
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold text-gray-900">Achievement Categories</h2>
      ...
      <div className="grid gap-4">
        {sortedCategories.map((category) => {
          ...
          const IconComponent = categoryIcons[category.name as keyof typeof categoryIcons] || Trophy;
              ...
              {isExpanded && (
                <CardContent className="pt-0">
                  <div className="space-y-3">
                    <h4 className="font-medium text-gray-900">Achievements in this category:</h4>
                            ...
                            <div className="flex items-center space-x-2">
                              <Badge 
                                ...
                                className={cn(
                                  ...
                                  status === 'in_progress' && 'border-yellow-300 text-yellow-700',
                                  status === 'locked' && 'border-gray-300 text-gray-500'
                                )}
                              >
      ...
      {categories.length === 0 && (
        <Card className="p-8 text-center">
          <div className="text-gray-500">
            ...
            <h3 className="text-lg font-medium mb-2">No Achievement Categories</h3>
            <p className="text-sm">
...
export const CategoryStats: React.FC<CategoryStatsProps> = ({
  ...
  const totalStats = useMemo(() => {
    ...
    return {
      ...
      locked: totalAchievements - completedAchievements - inProgressAchievements
    };
  }, [categories, userAchievements]);
