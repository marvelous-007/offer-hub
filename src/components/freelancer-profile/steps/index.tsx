...
const steps = [
  { key: 'user-choose-role', component: null },
  { key: 'user-select-job-type', component: <UserSelectJobType /> },
  { key: 'user-select-interested-category', component: null },
  ...
  { key: 'user-choose-languaje-active-state', component: null },
  ...
  { key: 'user-profile-set-uo-preview', component: null },
]
