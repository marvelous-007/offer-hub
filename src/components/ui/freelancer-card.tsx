...
export default function FreelancerCard({ name, title, avatar, rating, reviews, hourlyRate, verified }: Freelancer) {
  return (
    <div className="bg-white rounded-lg border border-gray-100 overflow-hidden hover:shadow-md transition-shadow">
      <div className="h-32 bg-gradient-to-r from-[#002333] to-[#15949C] relative">
        <div className="absolute -bottom-10 left-6">
          <div className="rounded-full border-4 border-white overflow-hidden h-20 w-20">
            <Image src={avatar || "/placeholder.svg"} alt={name} width={80} height={80} className="object-cover" />
          </div>
        </div>
      </div>
      <div className="pt-12 pb-6 px-6">
        <div className="flex items-center gap-2 mb-1">
          ...
          {verified && <CheckCircle className="h-4 w-4 text-[#15949C] fill-[#15949C]" />}
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <Button size="sm" className="bg-[#15949C] hover:bg-[#15949C]/90 text-white">
            Hire Me
          </Button>
        </div>
      </div>
