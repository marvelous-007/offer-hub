    ...
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-6">
      <motion.div variants={item}>
        <Alert className="bg-[#DEEFE7]/30 border-[#15949C]">
          ...
          <AlertTitle className="text-[#002333] font-medium">Tax Information</AlertTitle>
          <AlertDescription className="text-[#002333]/70">
            Your tax documents are generated quarterly and annually. Make sure your tax information is up to date for
            accurate reporting.
          </AlertDescription>
        </Alert>
      </motion.div>
                    ...
                    {taxDocuments
                      ...
                      .map((doc) => (
                        <div key={doc.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                          <div>
                            <p className="font-medium text-[#002333]">{doc.name}</p>
                    ...
                    {taxDocuments
                      ...
                      .map((doc) => (
                        <div key={doc.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                          <div>
                            <p className="font-medium text-[#002333]">{doc.name}</p>
                            <p className="text-xs text-[#002333]/70">{doc.description}</p>
                          </div>
                          <div className="flex items-center gap-2">
                            {getStatusBadge(doc.status)}
                            {doc.status === "available" && (
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-sm font-medium text-[#002333]/70 mb-2">Tax Profile</h3>
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          <span className="text-[#002333]/70">Tax Form</span>
                          <span className="font-medium text-[#002333]">W-9</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-[#002333]/70">Tax ID Type</span>
                          <span className="font-medium text-[#002333]">SSN</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-[#002333]/70">Tax Classification</span>
                          <span className="font-medium text-[#002333]">Individual/Sole Proprietor</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-[#002333]/70">Last Updated</span>
                          <span className="font-medium text-[#002333]">Jan 10, 2023</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-[#002333]/70 mb-2">Tax Settings</h3>
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          <span className="text-[#002333]/70">Automatic Tax Document Generation</span>
                        ...
                        <div className="flex justify-between">
                          <span className="text-[#002333]/70">Email Notifications</span>
                          <span className="font-medium text-green-600 flex items-center">
                            <CheckCircle className="h-4 w-4 mr-1" />
                            Enabled
                          </span>
                        ...
                        <div className="flex justify-between">
                          <span className="text-[#002333]/70">Document Format</span>
                          <span className="font-medium text-[#002333]">PDF</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div>
                  <h3 className="text-sm font-medium text-[#002333]/70 mb-2">Tax Resources</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Card>
                      <CardHeader className="pb-2">
                        <CardTitle className="text-sm">Tax Guidelines</CardTitle>
                      </CardHeader>
                      <CardContent className="text-xs text-[#002333]/70">
                        Learn about freelancer tax obligations and best practices
                      </CardContent>
                      <CardFooter>
                        <Button variant="ghost" size="sm" className="w-full text-[#15949C]">
                    ...
                    <Card>
                      <CardHeader className="pb-2">
                        <CardTitle className="text-sm">Tax Calculator</CardTitle>
                      </CardHeader>
                      <CardContent className="text-xs text-[#002333]/70">
                    ...
                    <Card>
                      ...
                      <CardContent className="text-xs text-[#002333]/70">
                        Get help with tax-related questions from our support team
                      </CardContent>
                      <CardFooter>
                        <Button variant="ghost" size="sm" className="w-full text-[#15949C]">
                          <ExternalLink className="h-3 w-3 mr-2" />
          ...
          <TabsContent value="uploads" className="space-y-6 mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Tax and business documents you've uploaded</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="border-2 border-dashed border-gray-200 rounded-lg p-8 text-center">
                  ...
                  <p className="text-[#002333] font-medium">Upload a new document</p>
                  <p className="text-sm text-[#002333]/70 mb-4">Accepted formats: PDF, JPG, PNG (max 10MB)</p>
                ...
                <div>
                  <h3 className="font-medium text-[#002333] mb-4">Required Documents</h3>
                  <div className="space-y-3">
